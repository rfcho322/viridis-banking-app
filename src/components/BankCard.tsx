...
const BankCard = () => {
    return (
        <div className='w-[375px] border border-white rounded-[20px]'>
            <div className='relative flex h-[119px] xl:h-[165px] w-[265px] sm:w-full xl:max-w-[375px] justify-between rounded-t-[20px] bg-bank-gradient backdrop-blur-[6px]'>
            ...
            <div className='h-[51px] xl:h-[70px] bg-bank-gradient backdrop-blur-[6px] w-[265px] sm:w-full xl:max-w-[375px] rounded-b-[20px]'>
