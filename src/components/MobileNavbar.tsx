                                ...
                                >
                                    ...
                                    >
                                        <div className='flex items-center gap-6 sm:pr-4'>
                                            <div className={cn('opacity-0 w-[6px] h-[50px] xl:h-[60px] bg-green-500 rounded-r-lg transition-opacity duration-500', {
                                                'opacity-100': isActive
                                            })} />
                                            <div className='relative size-6'>
                                                <item.Component selected={isActive} />
                                            </div>
                                            <p className={cn('text-[#B1B1B1] font-medium text-lg whitespace-nowrap', {
