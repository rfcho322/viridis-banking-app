                    ...
                    <div className='col-span-3 md:col-span-2 flex flex-col gap-5'>
                        ...
                        <div className='flex gap-[20px] lg:gap-[25px] xl:gap-[30px] no-scrollbar overflow-x-scroll'>
                            ...
                            <div className='w-[375px] border border-white rounded-[20px]'>
                                <div className='relative flex h-[119px] xl:h-[165px] w-[265px] sm:w-full xl:max-w-[375px] justify-between rounded-t-[20px] bg-white backdrop-blur-[6px]'>
                                ...
                                <div className='h-[51px] xl:h-[70px] bg-white backdrop-blur-[6px] w-[265px] sm:w-full xl:max-w-[375px] rounded-b-[20px]'>
